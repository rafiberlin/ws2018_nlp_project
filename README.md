...
Remark: To balance. This resulted in an overall smaller dataset of nearly 40000 documents.
...
4. ARK Tagger was used for tagging sentences with Part-of-Speech categories. The Tagger is optimized for Twitter data.
